...
subtitle: "Introduction to plotting in the tidyverse: ggplot2"
author:
...
```{r, echo = F, fig.height=5, fig.width=7, out.width='60%', fig.align='center', cache=TRUE}
...
local({
  ...
  animate(plot, fps = 3, device = "ragg_png", renderer = gifski_renderer())
})
```
...
<!-- ```{r, echo = F, fig.height=5, fig.width=10, out.width='90%'} -->
<!-- out$dotplot -->
<!-- ``` -->
...
```{r, out.width='90%', fig.width=10, fig.height=5, echo = F, fig.retina=2}
...
* We first define the data and mappping component of our plot to establish the base layer of the plot
...
<!-- ```{r, echo = T, eval = T, out.width='50%', fig.width=7, fig.height=5} -->
<!-- ggplot(data = df, mapping = aes(x = gender, y = age, fill = gender)) #<< -->
<!-- ``` -->
...
```{r, out.width='45%', echo = F, fig.align='center'}
